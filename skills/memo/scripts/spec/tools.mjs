...
export const tools = [
  ...
  { name: "spec_read", description: "Read up to 20 knowledge documents from one snapshot. Follow injected INDEX links directly to relevant documents. Returns the stored Markdown verbatim (including lifecycle frontmatter), an opaque revision, and explicit truncation. Missing files are reported and can be created with spec_edit. Continue with revision to keep related reads on the same snapshot.",
